package com.javarush.island.kavtasyev.view.guiview.controller;
...
//			return thread;
//		});
//		executor.scheduleAtFixedRate(statisticsUpdater, 0, IslandConfig.dayLength, TimeUnit.MILLISECONDS);



//	Runnable statisticsUpdater = () -> {
//		try
//		{
